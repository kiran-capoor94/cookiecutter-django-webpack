...
module.exports = (env, argv) => {
  ...
  if (!devMode) {
    ...
    output = {
      path: resolve('./{{ cookiecutter.project_slug }}/static/bundles/'),
  ...
  return {
    entry: {
      main: './{{ cookiecutter.project_slug }}/static/js/index.js'
    },
    output: output,
    module: {
      rules: [
        ...
        },
        {
          ...
          include: [
            ...
            resolve('./{{ cookiecutter.project_slug }}/static/fonts'),
            resolve('./{{ cookiecutter.project_slug }}/static/images'),
          ]
        }
      ]
    },
